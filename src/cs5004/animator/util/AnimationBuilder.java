...
/**
 * This interface defines the behavior that the implementing class should have when working
 * together with the AnimationReader class to parse an input text document and build up the
 * animation model for the Easy Animator application.
 * @author Zachary Jacobs
 *
 * @param <Doc> the animator model class type to build the animation to
 */
